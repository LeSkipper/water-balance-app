...
class WaterStats extends StatelessWidget {
  ...
  const WaterStats({super.key, required this.streak, required this.weekAverage, required this.todayPercent});
  ...
  Widget build(BuildContext context) {
    ...
    final stats = [
      ...
      (Icons.trending_up_rounded, l.avgDay, '$weekAverage ${l.ml}', const Color(0xFF10B981), c.isDark ? [const Color(0xFF1A3A2A), const Color(0xFF153320)] : [const Color(0xFFECFDF5), const Color(0xFFD1FAE5)]),
