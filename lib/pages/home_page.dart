          ...
          child: Column(
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: c.primary.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 4))],
                      ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('Hi, $firstName', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: c.textDark)),
                          Text('Stay hydrated, stay healthy', style: TextStyle(fontSize: 11, color: c.textMuted)),
                        ],
                      ),
                    ),
                    _iconButton(
                      ...
                      onTap: () {
                        ...
                        _showSnack(context, '🔄 Daily intake reset');
                      },
                    ),
              ...
              Padding(
                ...
                child: WaterProgress(current: currentIntake, goal: goal),
              ),
              // Quick add
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('QUICK ADD', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: c.textMuted)),
                    ...
                    QuickAddButtons(onAdd: (amount) {
                      ...
                      if (newTotal >= goal && prev < goal) {
                        _showSnack(context, "🎉 You've reached your daily goal!", isSuccess: true);
                      } else {
                        _showSnack(context, '💧 +$amount ml added');
                      }
                    }),
                  ],
                ),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: WaterStats(streak: provider.streak, weekAverage: weekAvg, todayPercent: todayPercent),
              ),
              const SizedBox(height: 16),
              // Weekly chart
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: WeeklyChart(data: weeklyData, goal: goal),
              ),
              const SizedBox(height: 16),
              // History
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("TODAY'S LOG", style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: c.textMuted)),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: IntakeHistory(entries: entries, onRemove: (id) {
                  provider.removeEntry(id);
                  _showSnack(context, 'Entry removed');
                }),
              ),
